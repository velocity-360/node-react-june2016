...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Shows = __webpack_require__(168);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Shows = function (_Component) {
		...
		function Shows(props, context) {
			...
			_this.state = {
				shows: [{ name: 'Two and a Half Men', network: 'cbs' }, { name: 'Kardashian Show', network: 'vh1' }, { name: 'Silicon Valley', network: 'hbo' }, { name: 'Game of Thrones', network: 'hbo' }]
			};
			return _this;
		}
		...
		_createClass(Shows, [{
			...
			value: function render() {
				var showList = this.state.shows.map(function (show, i) {
					return _react2.default.createElement(_ListItem2.default, { key: i, show: show });
				});
	...
	exports.default = Shows; // module.exports = Shows
		...
		_createClass(ListItem, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					', ',
					this.props.show.network.toUpperCase()
				);
			}
		}]);

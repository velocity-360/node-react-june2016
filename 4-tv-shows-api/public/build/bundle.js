...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Actors = __webpack_require__(168);
	
	var _Actors2 = _interopRequireDefault(_Actors);
	
	var _Shows = __webpack_require__(177);
		...
		_createClass(App, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(_Actors2.default, null),
					_react2.default.createElement(_Shows2.default, null)
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _APIManager = __webpack_require__(170);
	...
	var Actors = function (_Component) {
		...
		function Actors(props, context) {
			_classCallCheck(this, Actors);
	
			var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(Actors).call(this, props, context));
	
			_this2.updateActor = _this2.updateActor.bind(_this2);
			_this2.addActor = _this2.addActor.bind(_this2);
			_this2.state = {
				actor: {
					name: '',
					gender: '',
		...
		_createClass(Actors, [{
			...
			value: function componentDidMount() {
				var _this = this;
				_APIManager2.default.get('/api/actor', null, function (err, response) {
					if (err) {
						alert(err);
						return;
					}
					...
					_store2.default.dispatch(_actions2.default.actorsReceived(response.results));
				});
			}
		}, {
			key: 'updateActor',
			value: function updateActor(event) {
			...
			key: 'addActor',
			value: function addActor(event) {
				var _this = this;
				_APIManager2.default.post('/api/actor', this.state.actor, function (err, response) {
					if (err) {
						alert(err);
						return;
					}
					...
					_store2.default.dispatch(_actions2.default.actorCreated(response.result));
				});
			}
		}, {
			key: 'render',
			value: function render() {
				...
				var actorsList = this.props.actors.map(function (actor, i) {
					return _react2.default.createElement(_ListItem2.default, { key: i, type: 'actor', entity: actor });
				});
	
				return _react2.default.createElement(
					'div',
					{ style: { backgroundColor: '#f9f9f9', border: '1px solid #ddd', padding: 16 } },
					...
					_react2.default.createElement('input', { onChange: this.updateActor, placeholder: 'Name', id: 'name', type: 'text' }),
					_react2.default.createElement('br', null),
					_react2.default.createElement('input', { onChange: this.updateActor, placeholder: 'Gender', id: 'gender', type: 'text' }),
					_react2.default.createElement('br', null),
					_react2.default.createElement('input', { onChange: this.updateActor, placeholder: 'Age', id: 'age', type: 'text' }),
					_react2.default.createElement('br', null),
					_react2.default.createElement(
						'button',
	...
	exports.default = (0, _reactRedux.connect)(stateToProps)(Actors);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var superagent = __webpack_require__(171);
	...
	module.exports = {
		...
		post: function post(endpoint, params, callback) {
			superagent.post(endpoint).send(params).set('Accept', 'application/json').end(function (err, res) {
				if (err) {
					if (callback != null) callback(err, null);
					return;
				}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Shows = function (_Component) {
		_inherits(Shows, _Component);
	
		function Shows(props, context) {
			_classCallCheck(this, Shows);
	
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Shows).call(this, props, context));
	
			_this.updateNextShow = _this.updateNextShow.bind(_this);
			_this.addNextShow = _this.addNextShow.bind(_this);
			_this.state = {
				shows: [{ name: 'How I Met Your Mother', network: 'abc' }, { name: 'Big Bang Theory', network: 'cbs' }, { name: 'Game of Thrones', network: 'hbo' }],
				show: {
					name: '',
					network: ''
				}
		...
		_createClass(Shows, [{
			key: 'updateNextShow',
			value: function updateNextShow(event) {
			...
			key: 'addNextShow',
			value: function addNextShow(event) {
			...
			value: function render() {
				var showsList = this.state.shows.map(function (show, i) {
					return _react2.default.createElement(_ListItem2.default, { key: i, type: 'show', entity: show });
				});
	
				return _react2.default.createElement(
					'div',
					{ style: { marginTop: 24, backgroundColor: '#f1f9f5', border: '1px solid #ddd', padding: 16 } },
					_react2.default.createElement(
						'h2',
						null,
						'Shows'
					...
					_react2.default.createElement('br', null),
					_react2.default.createElement('br', null),
					_react2.default.createElement('input', { onChange: this.updateNextShow, value: this.state.show.name, type: 'text', id: 'name', placeholder: 'Name' }),
					_react2.default.createElement('br', null),
					_react2.default.createElement('input', { onChange: this.updateNextShow, value: this.state.show.network, type: 'text', id: 'network', placeholder: 'Network' }),
					_react2.default.createElement('br', null),
					_react2.default.createElement(
						'button',
						{ onClick: this.addNextShow },
						'Add Show'
					)
				);
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ActorsReducer = __webpack_require__(206);
	
	var _ActorsReducer2 = _interopRequireDefault(_ActorsReducer);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	// Combine Reducers
	var reducers = (0, _redux.combineReducers)({
	    actorsReducer: _ActorsReducer2.default
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
		...
		switch (action.type) {
			case _constants2.default.ACTORS_RECEIVED:
			...
			case _constants2.default.ACTOR_CREATED:
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
		...
		actorsReceived: function actorsReceived(actors) {
			return {
				type: _constants2.default.ACTORS_RECEIVED,
				actors: actors
			};
		},
	
		actorCreated: function actorCreated(actor) {
			return {
				type: _constants2.default.ACTOR_CREATED,
				actor: actor
			};
		}
